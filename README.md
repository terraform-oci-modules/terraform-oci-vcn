...
| [oci_core_local_peering_gateway.lpg](https://registry.terraform.io/providers/oracle/oci/latest/docs/resources/core_local_peering_gateway) | resource |
...
| <a name="input_vcn_cidr_block"></a> [vcn\_cidr\_block](#input\_vcn\_cidr\_block) | The primary IPv4 CIDR block for the VCN | `string` | `"10.0.0.0/16"` | no |
